...
insert  into `collg_details`(`collg_id`,`logo`,`collg_name`,`email`,`phone`,`pincode`,`city`,`state`) values 
(2,'static/collg/16f47bb3-2990-4d4b-8b04-a13bf3999927sign.jpg','gvm','abcd@fmail.com','1233333322',656768,'pala','kottayam');
...
(2,12,'static/company/471dfd4b-d3a0-4aa5-811d-fb84d19e37d5sign.jpg','tejas mulakupodi','ith erriyum','333333','kallara','kerala','3333333333','tejas@s.v');
...
insert  into `course_details`(`course_id`,`course_name`,`course_description`) values 
(1,'data mining','lorem');
...
insert  into `notifications`(`notif_id`,`notification`,`date_from`,`date_till`) values 
(1,'Al aBwaab Thuglaq','2024-03-14','14:27');
...
insert  into `staff`(`login_id`,`staff_id`,`f_name`,`l_name`,`phone`,`email`,`city`,`state`,`pincode`) values 
(13,1,'sreehari','v r','2222222222','svr@gmail.com','poonjattil','kottayam',369369);
